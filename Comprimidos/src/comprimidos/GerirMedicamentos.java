        ...
        while (true) {
            ...
            for (i = 0; i < meds.size(); i++) {
                if (meds.get(i).getid() == id) {
                    ...
                    System.out.print (
                    "Introduza a quantidade a tomar: ");
                        int quantidade = Read.Int();

                    System.out.print (

                    "Introduza a data da primeira toma no formato hh:mm, dd/mm/aa.\n");
                    System.out.print (
                    "Hora: ");
                        int h = Read.Int();
                    ...
                    System.out.print (
                    "Medicamento deve ser tomado de hora a hora ou de dias a dias(h/d): ");
                        char op = Read.Char();
